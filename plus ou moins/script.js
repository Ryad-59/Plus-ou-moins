...
const guessInput = document.getElementById("guessInput");   // L'input où on tape le nombre
const guessBtn = document.getElementById("guessBtn");     // Le bouton "Deviner"
const restartBtn = document.getElementById("restartBtn");   // Le bouton "Rejouer"
const messageBox = document.getElementById("message");   // La zone de message
const attemptCount = document.getElementById("attemptCount"); // Le compteur de tentatives
